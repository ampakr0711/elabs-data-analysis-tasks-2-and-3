...
```text
Elabs-Data-Analysis-and-Machine-Learning/
│
├── README.md
│
├── Task-2-Univariate-Regression/
│   ├── task2.ipynb
│   ├── dataset/
│   ├── outputs/
│   └── images/
...
# 📈 Task 2 — Univariate Regression using Gradient Descent
...
The regression model was implemented manually using mathematical optimization techniques.

The model updates weights iteratively to minimize prediction error.
